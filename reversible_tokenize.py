...
# This is an implementation of "A simple, reversible, language-agnostic tokenizer", published first in "Spell Once, Summon Anywhere: A Two-Level Open-Vocabulary Language Model" ( https://arxiv.org/abs/1804.08205 ), and obtainable at https://sjmielke.com/papers/tokenize/ .
#
